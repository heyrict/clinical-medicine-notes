...
1. 实验室检查 <!-- TODO: Add -->
    - 尿糖
    - 尿酮
    - 基础分泌、刺激后分泌（1 型：无基础分泌）

1. 诊断标准 <!-- TODO: Add --> <!--IMPORTANT-->

    | 空腹血糖 \ OGTT 2h | (0, 7.8) | [7.8, 11.1) | [11.1, +∞) |
    |--------------------|----------|-------------|------------|
    | (0, 6.1)           | NM       | HR          | DM         |
    | [6.1, 7.0)         | HR       | HR          | DM         |
    | [7.0, +∞)          | DM       | DM          | DM         |
