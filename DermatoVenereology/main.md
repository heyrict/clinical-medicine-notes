...
# 总论
1. 性病学：主要通过性接触传染而使泌尿系、皮肤、心脏等的疾病 <!--TODO: Add def -->
...
1. 棘层松解：表皮或上皮细胞失去粘连 <!--IMPORTANT: 名解-->

1. 实验室检查
    - 免疫病理检查
    - 斑贴试验：接触性皮炎 <!--IMPORTANT: 名解-->
    - 点刺试验：荨麻疹、特异性皮炎、药疹 <!--IMPORTANT: 名解-->
    - 划痕试验：荨麻疹患者皮肤表面有钝器以适当压力划过，出现以下三联反应 <!--TODO: Add --> <!--IMPORTANT: 名解-->
        - 3 - 15 secs: 划过处出现红色线条
        - 15 - 45 secs: 红色线条两侧出现
    - Koebner 现象 <!--TODO: Add --> <!--IMPORTANT: 名解-->
    - 滤过紫外线试验
    - 性病实验室检查
        - 淋球菌试验
        - 梅毒螺旋体检查
        - 醋白试验：尖锐湿疣（HPV） <!--IMPORTANT: 名解--> <!--TODO: ？现象 -->
    - 皮肤螨虫检查
    - 三维皮肤 CT

1. 常用药物
    - 外用药物 <!--TODO: Add --> <!--IMPORTANT: 问答题-->
        - 根据合适疾病选择合适外用药物
        - 根据临床症状和皮损特点选择剂型
            - 急性炎症
            - 亚急性炎症
...
1. Ramsay-Hunt Syndrome: 膝状神经节受累 <!--TODO: Add --> <!--IMPORTANT: 名解-->
...
1. 尼氏征 <!--TODO: Add def --> <!--IMPORTANT: 名解-->
...
## 药疹
1. 药疹 <!--IMPORTANT: 名解--> <!--TODO: Add -->

1. 变态反应性药疹的特点 <!--TODO: Add -->

1. 重症药疹的救治原则 <!--TODO: Add -->

# 性传播疾病
## 概述
1. 性传播疾病 (STD): 主要通过性接触、类似性行为、间接性接触传染的一组疾病 <!--IMPORTANT: 名解-->

1. 性传播疾病的病原微生物 <!--TODO: Add --> <!--IMPORTANT-->
...
1. 辅助检查 <!--TODO: Add 检查方法及意义 --> <!--IMPORTANT-->
    - TP 直接检查（镜检）：硬下疳或扁平湿疣者
    - 梅毒血清学试验 <!--IMPORTANT: 问答题-试验及其临床意义-->
        - 非特异性：抗心磷脂抗体 (VDRL, USR, RPR)
        - 特异性：抗梅毒螺旋体抗体 (FTA-ABS, TPHA, TPPA)
