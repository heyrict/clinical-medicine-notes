...
1. 第二信使定义: 第一信使作用于细胞膜后产生的细胞内信号分子.
...
1. 阈值: 引起细胞产生AP所需最小刺激强度
    - 阈上刺激
    - 阈下刺激

1. 阈电位: 由阈刺激引起的膜内电位去极化达到引发AP产生的临界值
...
#### N-M接头处兴奋传递
1. 结构: 运动神经末梢 + 骨骼肌细胞
1. 传递: AP --> 神经末梢 --> $Ca^{2+}$通道开放 --> 突触小泡中ACh量子释放
...
1. 舒张过程: 肌质网Ca泵作用 --> 胞质$Ca^{2+}$浓度下降 --> 肌肉舒张

#### 影响横纹肌收缩效能的因素
1. 负荷
    - 前负荷: 粗细肌丝重叠面积.
    - 后负荷
1. 肌收缩能力: 主要取决于$Ca^{2+}$水平与横桥ATP酶活性
1. 收缩的总和
    - 数量的总和: 参与收缩的运动单位
    - 频率的总和
        + 单收缩
...
|相对不应期|复极3期-60mV->-80mV|大于正常| 阈上刺激产生低幅度AP |  大部分复活  |
|  超常期  |复极3期-80mV->-90mV|小于正常|阈下刺激产生稍低幅度AP|基本复活至备用|
...
### 能量代谢
#### 能量代谢的测定
1. 定义: 生物体内物质代谢伴随的体内能量的释放、转移、贮存、利用
1. 概念
    - 热价
        + 食物热价: 1g物质在氧化时释放的热量
        + 氧热价: 物质消耗1L O₂释放的热量
...
1. 肾糖阈: 尿中开始出现Glu时的血糖浓度 (正常: 180mg/100ml)
...
#### 神经胶质细胞
1. 数量: 神经元的10 ~ 50倍
1. 形态结构: 有突起, 无树突和轴突之分; 有缝隙连接, 无化学性突触

### 神经系统功能活动的基本原理
#### 突触
1. 定义: 一个神经元轴突末梢与其他神经元的胞体或突起接触处所形成的特殊结构
1. 化学性突触
1. 分类
    - 轴突-树突式突触
    - 轴突-胞体式突触
...
#### 神经递质
1. 定义: 有突出前神经元合成并在末梢处释放特异性作用于突触后神经元或效应器细胞上的受体,
...
1. 两条回路
    ...
    - 间接通路
        + 皮层 --> 兴奋新纹状体 --> 抑制苍白球外侧部 --> 抑制丘脑底核 --> 兴奋丘脑 --> 抑制皮质运动前区
    - 黑质的调节
        + 释放多巴胺DA
        + 兴奋直接通路
        + 抑制间接通路
1. 基地神经节病变 <!--TODO: Add table: 舞蹈病、帕金森氏病-->
...
1. 允许作用: 自身不产生生物学效应, 但能使另一种激素发挥生物学效应.
