...
### 神经系统检查
#### 精神状态
1. Broca 失语（运动性失语）：患者能够理解他人言语，能够发音，但言语产生困难 <!-- IMPORTANT -->
...
1. 房早未下传: 呈倍数代偿间期，前方 T 波可见与 P 波叠加，其后无 QRS 波

1. 房早伴差异性传导: 呈倍数代偿间期，前方 T 波可见与 P 波叠加，其后伴 QRS 波
...
1. 传导阻滞
    ...
    - 不完全性：QRS &lt; 3 小格
        ...
        - 左束支：V2 rS 型 QRS 波，V5 M 型 QRS 波 (高侧壁、前侧壁切迹)
            - 左前分支：电轴左偏，III R 负值 > II R 负值，aVL R 正值 > I R 正值
            - 左后分支：电轴右偏
...
1. 急性肺栓塞: I Rs 型，III Qr 型，III T 波低平
