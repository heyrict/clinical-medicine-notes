...
1. 生理性抗凝物质: 丝氨酸蛋白酶抑制物（抗凝血酶）、蛋白质 C 系统、组织因子途径抑制物、肝素
1. 自动去极化电流
...
1. Cajal 间质细胞产生慢波不受神经支配，但受神经、体液、机械刺激的影响
...
1. T3 寿命短，活性大，数量少; T4 为 T3 前体，含量多; TSH 最敏感
1. 除交感兴奋、生长抑素外，几乎所有激素都促进胰岛素分泌
1. hCG 起 LH 作用，10 周高峰; hPL 起生长激素作用
...
1. 其他真核和原核区别
    - 碱基切除修复
        - 原核: Uvr A,B (识别)、C (切除)、DNA pol I
        - 真核: PCNA (增殖细胞核抗原)、核酸**内切酶**、DNA pol ε
    - 肽链延长
...
1. 脂肪动员关键酶: HSL, ATGL
1. 脂肪酸合成仅消耗 NADPH，分解产生 NADH, FADH2
...
1. 不同药物禁忌症
    - β-受体阻滞剂: 动脉、平滑肌痉挛疾病；急性心衰、严重 AVB、HR < 60；水肿
