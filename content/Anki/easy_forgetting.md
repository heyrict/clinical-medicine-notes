...
1. 中枢/外周感受器细胞都不感受 CO2 浓度变化，感受的是氢离子浓度
...
1. 感受器电位: 大部分为去极化电位，感光细胞为超极化电位 (视杆细胞不能去极化，但静息电位较低，暗电流产生局部电位促进谷氨酸释放)
...
1. 急性肾炎水肿机制: 水钠潴留 (GFR 下降，重吸收正常)、循环血量增加、组织水肿;
   肾综水肿机制: 虽然血容量减少，但胶体渗透压降低、RAAS, ADH 激活
...
1. IF-2, EF-Tu/G, RF-3, eEF-1α/2 具有 GTPase 活性
1. 花生四烯酸属于第二信使
1. 神经纤维直径影响速度，不影响幅度
...
1. 各种金属离子
    - 铯: $I_f$ 通道阻滞药
    - 镍: T 型钙通道阻滞药
    - 锰: L 型钙通道阻滞药; 脂肪酸合成激活剂; 与肝性脑病有关
    - 镁: 促进肾小管上皮保钾; 拮抗钙，抑制突触后递质的释放; 促进 G 蛋白偶联受体 AC 生成 cAMP
    - 铁过载: 可致 CKD
...
1. 其他真核和原核区别
    - 碱基切除修复
        ...
        - 真核: PCNA (增殖细胞核抗原)、糖苷酶、核酸**内切酶**、DNA pol β/ε
    - 肽链延长
...
1. 芳香族氨基酸 (含共轭双键的氨基酸): Phe (但无 280 nm 吸收峰), Trp, Tyr
...
1. 氨基甲酰磷酸合成酶 I 的激活剂: N-乙酰谷氨酸 (N-AGA)
...
1. 生成 FAD 的反应底物：**琥珀酸、脂酰CoA、α-磷酸甘油、二氢鞘胺醇、L-氨基酸氧化 (肝肾内，除外 L-谷氨酸为 NAD/NADP)**
...
1. 结核毛细血管扩张引起少量咯血；小血管损伤、血管瘤破裂引起大咯血
...
1. 特殊类型糖尿病
    - MODY: 常显、青年发病、无酮症倾向
    - 线粒体基因突变糖尿病: 身材消瘦、早期发病、自身抗体阴性、常伴耳聋或其他神经肌肉表现
...
1. SLE 最常见和最严重表现: 狼疮肾炎
   SLE 与其他自身免疫病鉴别: SLE 常伴发热、**自身免疫性溶血性贫血**
1. Jaccoud 关节病: SLE 可复型非侵蚀性关节半脱位，无骨质破坏
1. SS 累及肾可出现肾小管性酸中毒，引起周期性瘫痪；淋巴瘤发生率显著升高
...
1. 胆囊结石和胆囊炎**不伴黄疸 (肝酶升高)**; 胆囊癌转氨酶不升高; 胆管癌**肝大，但不影响肝功能** (转氨酶轻度异常);
