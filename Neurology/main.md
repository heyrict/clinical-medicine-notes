...
1. 三叉神经：面部感觉、口腔感觉、运动 <!--TODO: Add -->
    ...
    - 深感觉：中脑核
    - 浅感觉：脊柱核
    - 三叉神经核病变：同侧剥洋葱样分离性改变 <!--TODO: Add --> <!--IMPORTANT-->
...
1. 周围性面瘫与中枢性面瘫 <!--IMPORTANT--> <!--IMPORTANT-->

1. Hunt 综合征：膝状神经节累及 <!--IMPORTANT--> <!--TODO: Add -->
...
| 神经 | 椎间盘 | 感觉                             | 运动                 | 反射             |
|------|--------|----------------------------------|----------------------|------------------|
| C5   | C4-C5  | 三角肌                           |                      | 肱二头肌、桡骨膜 |
| C6   | C5-C6  | 拇指、示指                       |                      | 肱二头肌、桡骨膜 |
| C7   | C6-C7  | 前臂背侧、示指、中指、环指       |                      | 肱三头肌         |
| C8   | C7-T1  | 前臂两侧、掌、环指、小指         | 手肌                 | Hoffman          |
| L4   | L3-L4  | 大腿前外侧、膝、小腿前内侧、内踝 | 股四头肌(伸膝)       | 膝               |
| L5   | L4-L5  | 小腿外侧、足背、足底、拇指       | 胫前肌(屈膝、足背屈) |                  |
| S1   | L5-S1  | 大/小腿后外侧、外踝、小指        | 小腿三头肌(足跖屈)   | 跟腱             |
...
1. 上运动神经元 <!--TODO: Add def --> <!--IMPORTANT-->

1. 下运动神经元 <!--TODO: Add def --> <!--IMPORTANT-->
...
1. Hoffman 综合征： <!--TODO: Add pos --> <!--IMPORTANT-->
...
## 脑干
1. 延髓腹外侧综合征 <!--IMPORTANT--> <!--IMPORTANT--> <!--TODO: Add 第二章第一节 -->

1. 闭锁综合征：神智清醒，仅能进行眼球上下运动，脑桥基底部病变 <!--IMPORTANT--> <!--TODO: Add -->
...
1. 中枢性失明：枕叶损害，出现失明，但光反存在 <!--IMPORTANT-->
...
1. 瞳孔调节障碍
    - 瞳孔调节 <!--IMPORTANT-->
        ...
        - 出路：动眼神经
    - 瞳孔散大：动眼神经麻痹、视神经损害等
    - Horner Sign: 单侧瞳孔缩小，眼裂变小，眼球内陷，可伴同侧面部少汗。见于颈上神经径路损害或脑干网状结构交感纤维损害。 <!--IMPORTANT: 名解-->
...
# 脑血管疾病
## 概述
1. Willis 环：大脑中动脉不参与组成 <!--IMPORTANT-->
...
1. 诊断
    - 确诊依据：IgM, IgG <!--TODO: Add --> <!--IMPORTANT-->
...
1. 治疗: > 65 y/o 或伴智能损害者首选多巴胺 <!--IMPORTANT: 问答题-->
    - 早期：鼓励患者多做主动运动
...
1. 开关现象：剂量过高时会产生乱动 <!--TODO: Verify --> <!--IMPORTANT-->
...
# 癫痫
## 癫痫
1. 癫痫：不同病因导致脑部神经元异常放电，表现为 <!--TODO: Add def --> <!--IMPORTANT: 名解--> <!--IMPORTANT-->
...
1. 失神发作与复杂性发作的鉴别表 <!--TODO: Add -->

1. 失神发作脑电波特点 <!--IMPORTANT--> <!--TODO: Add -->
...
1. 临床表现
    ...
    - 重症肌无力危象：呼吸肌受累时出现咳嗽无力、呼吸困难 <!--IMPORTANT: 名解-->
    - 胆碱能危象 <!--IMPORTANT: 名解--> <!--TODO: Add -->
    - 反拗危象 <!--IMPORTANT: 名解--> <!--TODO: Add -->

1. 辅助检查
    - 疲劳试验
    - 重复神经电刺激 (RNES) <!--TODO: Add data -->
